...
- Added Django 5.1 to the list of supported Django versions.
- Added Django 5.2 to the list of supported Django versions.

### Changed

- Updated pythonbible dependency to version 0.14.0.
- Switched package build and publish tool from flit to uv.
- Switched linting tool from flake8 to ruff and mypy.
...
[unreleased]: https://github.com/avendesora/djangobible/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/avendesora/djangobible/compare/v0.2.1...v0.3.0
